<?php 
  $url2 = Ruta::ctrlRuta();  
    $respuesta = ControladorRegistroAdminGeneral::consultarRegistroExisteBD("Estantes","tipocontrato","nombre");
...
<section class="home-section">
  <div class="container mt-3 fs-5 ms-5">
    ...
    <div class="container-fluid blogs text-center">
	        <h1 class="mt-5 mb-5">Administración del formato de estantes</h1>
                 ...
                 <a href ="javascript:miFuncion(<?php echo $respuesta["idTipoContrato"]?>)"><i class="far fa-check-circle fs-1 mb-3" data-toggle="tooltip"  title="Modificar"></i></a>
                 <a href ="javascript:mostrarModalVistaPrevia()"><i class="fas fa-search fs-1 mb-3" data-toggle="tooltip"  title="Vista previa"></i></a>

                 <form class="form needs-validation" method="post"  enctype="multipart/form-data" novalidate>
                       <div class="form-group ms-5">   
                       <div class="ms-5">
                       <div class="ms-5">
                            <textarea class="form-control w-75 h-75 ms-5" id="formateEstante" rows="100" cols = "100"  ></textarea>
...
<form class="form needs-validation" method="post"  enctype="multipart/form-data" novalidate>
  ...
  <form class="form needs-validation" method="post"  enctype="multipart/form-data" novalidate>
        <div class="modal fade" id="modalVistaPrevia" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                       ...
                                       <div class="modal-header " style ="background-color: #006C9E;color:#FFFFFF;" >
                                            ...
                                            <div class="row">
                                                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-2" id="">
                                                      <div class="col-sm-12" id="verPrevio">
