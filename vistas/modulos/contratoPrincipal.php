        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center me-0" > 
         <form class="ms-0">
          ...
          <div class="container-fluid well well-sm barraProductos p-5 text-center col-md-12 ms-2 me-4">
            <h1 class="tituloContratos text-dark ms-0 me-5">Crear contrato estante</h1>
          </div>
...
<div id="cajasContrato" class="text-center">
  <div class="container mt-3 fs-5">
        ...
        <ul class="grid0">
          <div class="row">
           <div class="col-md-4">
            <a href="javascript:mostrarContratoEstante()" class="link-dark">
          ...
          <div class="col-md-4">
            <a href="javascript:mostrarContratoBotellon()" class="link-dark">
              <div class="border m-3 p-3 bg-light div-admin rounded">
          ...
          <div class="col-md-4">
            <a href="javascript:mostrarContrato()" class="link-dark">
              <div class="border m-3 p-3 bg-light div-admin rounded">
                <i class="fas fa-file-contract iconosAdmin"></i>
