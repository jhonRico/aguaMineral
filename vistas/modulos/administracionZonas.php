...
<div class="container mt-3 fs-5 ms-5">
        <nav aria-label="breadcrumb" class="ms-5">
          <ol class="breadcrumb" class="ms-5">
            ...
            <li class="breadcrumb-item active" aria-current="page" class="">Zonas</li>
          </ol>
        </nav>
  </div> 
<form method="post" id="formulario" autocomplete="off" class="m-5 fp-5">
  <div class="m-5 p-5">
    ...
    <tr>
      <th scope="col"></th>
      <th scope="col"></th>
      <th scope="col" class="ms-5"><h3 class="display-6 ms-5">Zonas</h3></th>
      <th></th>
      <th></th>
      <th scope="col">
        <div class="me-5 ms-0">
                           ...
                           <div class="modal-content">
                                      ...
                                      <div class="modal-body mx-3">
                                             <div class="modal-body">                       
                                                   <input   type="text" class="form-control" id="nameZona" name ="nameEstado" placeholder="Por favor ingrese el perfil" required>  
                                             </div>
                                      </div>
