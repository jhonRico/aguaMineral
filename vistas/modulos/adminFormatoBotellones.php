<?php 
  $url2 = Ruta::ctrlRuta();  
  $respuesta = ControladorRegistroAdminGeneral::consultarRegistroExisteBD("Botellones","tipocontrato","nombre");
...
<body class="bg-light">
  <div class="container mt-3 fs-5 ms-5">
    ...
    <div class="container-fluid blogs text-center">
	        <h1 class="mt-5 mb-5">Administración del formato de botellones</h1>
                 ...
                 <a href ="javascript:miFuncionBotellon(<?php echo $respuesta["idTipoContrato"]?>)"><i class="far fa-check-circle fs-1 mb-3" data-toggle="tooltip"  title="Modificar"></i></a>
                 <a href ="javascript:mostrarModalVistaPreviaBotellon()"><i class="fas fa-search fs-1 mb-3" data-toggle="tooltip"  title="Vista previa"></i></a>

                 <form class="form needs-validation" method="post"  enctype="multipart/form-data" novalidate>
                       <div class="form-group ms-5">   
                       <div class="ms-5">
                       <div class="ms-5">
                            <textarea class="form-control w-75 h-75 ms-5" id="formateBotellon" rows="60" cols = "80" ></textarea>
...
<form class="form needs-validation" method="post"  enctype="multipart/form-data" novalidate>
  ...
  <form class="form needs-validation" method="post"  enctype="multipart/form-data" novalidate>
        <div class="modal fade" id="modalVistaPreviaBotellon" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                       ...
                                       <div class="modal-header " style ="background-color: #006C9E;color:#FFFFFF;" >
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-2" id="">
                                                      <div class="col-sm-12" id="verPrevioBotellon">
